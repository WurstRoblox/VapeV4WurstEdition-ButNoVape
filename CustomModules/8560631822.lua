...
shared.CustomSaveWurst = 6872274481
if pcall(function() readfile("wurst/CustomModules/6872274481.lua") end) then
	loadstring(readfile("wurst/CustomModules/6872274481.lua"))()
else
	local publicrepo = wurstGithubRequest("CustomModules/6872274481.lua")
	if publicrepo then
