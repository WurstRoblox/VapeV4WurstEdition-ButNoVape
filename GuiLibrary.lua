if shared.WurstExecuted then
	...
	local wurstAssetTable = {
		...
		["wurst/assets/DiscordIcon.png"] = "rbxassetid://13546311177",
	...
	GuiLibrary["CreateMainWindow"] = function()
		...
		settingsbox2.Text = "Wurst "..VERSION.."  "
		...
		discordbutton.Image = downloadWurstAsset("wurst/assets/DiscordIcon.png")
		...
		discordbutton.MouseButton1Click:Connect(function()
			...
			task.spawn(function()
				...
				setclipboard("https://discord.com/invite/T8dMNcVW2n")
				task.wait(1)
				hoverbox3:Remove()
			end)
		end)
